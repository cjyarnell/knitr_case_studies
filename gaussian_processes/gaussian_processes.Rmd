...
setwd("C:/Git/knitr_case_studies/gaussian_processes")
```
...
dens <- lapply(lambda, function(l) dgamma(1 / l, 4, rate=10) * (1 / l**2))
plot(lambda, dens, type="l", col=c_dark_highlight, lwd=2,
     xlab="lambda", ylab="Prior Density", yaxt='n')

lambda98 <- seq(1, 12, 0.001)
dens <- lapply(lambda98, function(l) dgamma(1 / l, 4, rate=10) * (1 / l**2))
lambda98 <- c(lambda98, 12, 1)
dens <- c(dens, 0, 0)
